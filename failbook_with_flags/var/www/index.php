...
$realSession = session_id();

session_write_close();
session_id("11111111111111111111111111");
session_start();
$_SESSION['flag12'] = "c2FyY2FzdGFiYWxsCg==";
session_write_close();

session_id($realSession);

session_start();
unset($_SESSION['flag12']);
$_SESSION['flag11'] = "U2F5IG5vIHRvIGZsYWdzCg==";
?>
